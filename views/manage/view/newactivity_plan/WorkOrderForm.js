Ext.define('manage.view.newactivity_plan.WorkOrderForm', {
	extend : 'Ext.form.FormPanel',
	alias : 'widget.plannewworkorderform',
	requires : [ 'manage.view.ux.ComboBox','manage.view.ux.UEditor' ],
//	bodyPadding : 10,
	header : false,
	id : 'plannewworkorderform',
	buttonAlign : 'center',
	...
	upLoadForm.submit({
		...
		success : function(form, action) {
			top.Ext.Msg.alert('上传成功', action.result.msg == null ? '上传成功'
				...
				var replyForm = Ext.getCmp('plannewworkorderform').form;
