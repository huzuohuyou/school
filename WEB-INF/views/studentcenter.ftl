	...
	<div id="contents">
		<div id="adbox">
			<div class="clearfix">
				...
				<div class="detail">
					<h2>${user.getName()} 同学您好： </h2>
					<h3>迎登录阳光丽和课后一小时管理平台<br> Welcome to use this system.</h3>
				</div>
			</div>
		</div>
		...
		<div class="featured">
			...
			<ul class="clearfix">
				...
				<li>
					...
					<#list homework as item>
				    	<p >
							[${item.date}]·<a href="javascript:getHomeWork('${item.t_name}','${item.date}','${item.course_name}','${item.content}')">${item.course_name}</a>
						</p>
				    </#list>	
				</li>
				<li>
