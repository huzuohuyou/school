...
<#if sub.t_id=='title'>
<li><span class="span-menu">${sub.name}</span></li>
<#else>
<li>
<#if sub.url?? && sub.url!=''>
...
<#if list.title?length gt 15>${list.title?substring(0,15)}...</br><#else>${list.title}</#if>
	...
	<div class="hd-3">
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="320px">
          ...
          <tr>
            <td><a href="${sys.webRoot}/list/253/1.html"><img src="resource/images/p3.jpg" /></a></td>
          </tr>
          <tr>
...
<div class="width-1200" style="height:430px;">
    ...
    <div>
    	...
    	<div id="Tab1">
            <div class="Menubox">
            <ul>  
               <li id="one1" onmouseover="setTab('one',1,4)" class="Menubox-li-hover" >课后一小时</li>
               <li id="one2" onmouseover="setTab('one',2,4)"  >校本课</li>
               <li id="one3" onmouseover="setTab('one',3,4)"  >社团课</li>
               <li id="one4" onmouseover="setTab('one',4,4)"  >开放性科学课</li>
            </ul>
        ...
        <div id="Tab2">
            <div class="Menubox">
            <ul> 
               <li id="two1" onmouseover="setTab('two',1,4)" class="Menubox-li-hover" >学前课程</li>
               <li id="two2" onmouseover="setTab('two',2,4)"  >艺考培训</li>
            </ul>
