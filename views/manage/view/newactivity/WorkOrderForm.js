Ext.define('manage.view.newactivity.WorkOrderForm', {
	extend : 'manage.view.moudle.Form',
	alias : 'widget.newworkorderform',
			    ...
			    items:[{
	 	 		...
	 	 		//		labelAlign : 'right',
	 	 			...
	 	 			//	labelAlign : 'right',
	 	 				...
	 	 				vtype: 'checkContractNumber',
	 			        vtypeText: "该合同编号已经存在！",
	 	 				regex: /^[a-zA-Z0-9]{14}$/,
	 					regexText : '输入正确的14位合同编号',
	 	 				afterLabelTextTpl : required,
						emptyText : '样式：YGLH2018HD0001',
						blankText : '此项为必填项',
						allowBlank : false
	 	 			},{
	 	 				xtype : 'mycombo',
			            ...
			            items:[ {
				            ...
				            items:[{
								...
								allowBlank : false
			 					...
			 					emptyText : '涵盖年级，可多选',
			 					name : 'stages',
			 					store:[["1","一"],["2","二"],["3","三"],["4","四"],["5","五"],["6","六"],["7","七"],["8","八"],["9","九"],["10","高一"],["11","高二"],["12","高三"]],
			 					editable : false,
			 					multiCascade : true,
			 					multiSelect : true,
			 					maxLength : 50,
						        ...
						        listeners: {
						        	select : function( field, value, eOpts){
						        		this.up('form').form.findField('pre_end_date').setMinValue(value);
						        	}
						        }
								...
								name : 'planId',
								fieldLabel : '指定策划人',
								store : Ext.create('manage.store.newactivity.Queryplan',{
									autoLoad : {limit : 1000,start : 0}
								}),
								editable : false,
								afterLabelTextTpl : required,
	...
	upLoadForm.submit({
		...
		success : function(form, action) {
			top.Ext.Msg.alert('上传成功', action.result.msg == null ? '上传成功'
				...
				var replyForm = Ext.getCmp('newworkorderform').form;
