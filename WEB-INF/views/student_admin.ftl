...
<SCRIPT language=javascript>
				...
				Ext.Ajax.request({
					...
					success : function(result, request) {
						...
						if (obj.success == true) {
							msg.color = 'blue';
							msg.innerHTML = '登录成功！';
							 if(obj.grad =="" ||obj.grad == null ){
		                       alert("您还没有完善个人信息，请尽快完善！");
		                    } 
		...
		function doRegist()
		{  
			window.location.href = 'regist.jspx';
		}
...
<div class="width100">
	<div class="boxbg">
        ...
        <table border="0" cellspacing="0"  cellpadding="0" width="450" height="520" >
          <tr>
            <td height="64" colspan="2" align="center" valign="middle" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="56%">&nbsp;&nbsp;&nbsp;&nbsp;<span class="f18636363">学生登录</span></td>
              </tr>
          ...
          <tr>
            <td height="60" colspan="2" align="center" valign="bottom">
            	<input type="text" onKeyPress="keyPress(event);" id=username maxLength=20 name=username placeholder="请输入教育ID" class="input2"/>
          ...
          <td height="30" colspan="2" align="center">
            <a href = "#" onclick=doRegist(); style = "text-decoration: none;">没有账号？注册</a>
          </td>
           </tr>
          <tr>
          <td>
          ...
          <tr>
            <td height="57" colspan="2" align="center" class="f12c3c3c3" >版权所有：北京阳光丽和有限公司</td>
          </tr>
        </table>
    	</div>
