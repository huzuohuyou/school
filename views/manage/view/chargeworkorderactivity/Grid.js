Ext.define('manage.view.chargeworkorderactivity.Grid', {
	extend : 'manage.view.moudle.querymoudle.Grid',
	alias : 'widget.chargeworkorderactivitygrid',
	
	initComponent : function() {
		var store = Ext.create('manage.store.activity.ChargeWorkOrderActivity');
