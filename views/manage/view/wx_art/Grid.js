Ext.define('manage.view.wx_art.Grid', {
	extend : 'manage.view.moudle.querymoudle.Grid',
	alias : 'widget.wx_artgrid',
	initComponent : function() {
		var store = Ext.create('manage.store.wx_art.Wx_art');
		...
		Ext.apply(this, {
			...
			},
			{
				...
				isDisabled : function(view, rowIdx, colIdx, item, record) {
					if ((session.authority.indexOf('b350903') > -1)&&record.data.stickie =='1')
						return false;
					else
						return true;
				}
