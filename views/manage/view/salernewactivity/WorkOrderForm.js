Ext.define('manage.view.salernewactivity.WorkOrderForm', {
    extend: 'manage.view.moudle.Form',
	alias : 'widget.salernewworkorderform',
	...
	initComponent : function() {
		...
		Ext.applyIf(me,{
			items : [ {
				...
				xtype : 'mycombo',
				store : Ext.create('manage.store.schools.AddSchool',{
			...
			{
				xtype : 'mycombo',
				store : Ext.create('manage.store.activity.SchoolInOut',{
					autoLoad : {limit : 100,start : 0}
				}),
				width : 300,
				queryMode : 'local',
