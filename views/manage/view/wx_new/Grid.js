Ext.define('manage.view.wx_new.Grid', {
	extend : 'manage.view.moudle.querymoudle.Grid',
	alias : 'widget.wx_newgrid',
	
	initComponent : function() {
		var store = Ext.create('manage.store.wx_new.Wx_new');
		...
		Ext.apply(this, {
			...
			tbar : [ {
				...
				iconCls : 'item-add',
				xtype : 'button',
				hidden : session.authority.indexOf('b350102') > -1 ? false : true,
				action : 'insert',
				text : '添加'
			}, '-', {
				iconCls : 'item-delete',
			...
			},
			{
				...
				isDisabled : function(view, rowIdx, colIdx, item, record) {
					if ((session.authority.indexOf('b350103') > -1)&&record.data.stickie =='1')
						return false;
					else
						return true;
				}
