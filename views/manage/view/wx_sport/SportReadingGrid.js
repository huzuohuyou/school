Ext.define('manage.view.wx_sport.SportReadingGrid', {
	extend : 'manage.view.moudle.querymoudle.Grid',
	alias : 'widget.sportreadinggrid',
	initComponent : function() {
		var store = Ext.create('manage.store.wx_sport.SportReading');
		...
		Ext.apply(this, {
			...
			},
			{
				...
				isDisabled : function(view, rowIdx, colIdx, item, record) {
					if ((session.authority.indexOf('b351003') > -1)&&record.data.is_show =='1')
						return false;
					else
						return true;
				}
